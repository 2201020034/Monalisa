...
# Ukuran peta akan disesuaikan otomatis berdasarkan ukuran gambar
...
def load_map(file_path):
    global map_img, WIDTH, HEIGHT, SCALED_WIDTH, SCALED_HEIGHT
...
def is_road(color):
    return all(90 <= c <= 150 for c in color[:3])  # Sesuaikan dengan warna jalan di gambar
...
def main():
    ...
    try:
        load_map("assets/map.jpg")  # GANTI file dari .png ke .jpg
    except:
